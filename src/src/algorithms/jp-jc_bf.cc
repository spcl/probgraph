...
int64_t OrderedCount(const Graph &g, float tres, int k_, int m_,float tau, std::string graphName, int threads) {
    ...
    std::cout << "RRR JP-JC BF JP-JC_BF " << graphName << " " << threads << " " << g.num_nodes() << " " << g.num_edges() << " " << tres << " " << k_temp << " " << m_temp << " " << tau << " " << pp_time << " " << alg_time << " " << pp_time + alg_time <<  " " << total << std::endl;
    ...
    std::cout << "SSS JP-JC BF JP-JC_BF " << graphName << " " << threads << " " << g.num_nodes() << " " << g.num_edges() << " " << tres << " " << k_temp << " " << m_temp << " " << tau << " " << approx_str_size << " " << initial_csr_size << " " << approx_str_size + initial_csr_size << " " << total << std::endl;
